...
mixed *story = 
({
        "某天笨笨正在扬州城内，提笼架鸟满街遛，忽然集市上一阵骚动",
        "某人：不好啦，野羊山土匪下山啦，大家快跑啊！……",
        "没等笨笨反应过来，一伙土匪已经窜到他面前，抽出西瓜刀……",
        "土匪：不许动，把所有值钱的东西交出来！",
        "笨笨想大声呼救，结果发现没有一个人了，都溜的精光，跑的比球还快。",
        "没办法，看着刀已经抵上了前胸后背，形势危急……",
        "“快点！m d，大爷没时间跟你磨蹭！”土匪头子大叫。",
        "笨笨“嘿嘿”地奸笑了两声，“勒索我？谁勒谁呀？”",
        "只见笨笨高举双手，大喝：“去死把!”, 只见天上一道电光闪过，",
        "咆哮的雷暴自天而降，向着地上奔去……",
        (: give_gift :),
        "……",
        "………………",
        "土匪头子吓了半晌，破口大骂：“n n d，你这家伙玩的什么把戏？”",
        "笨笨心中一凛，“坏了，劈错了，如今三十六计，惟有上计……”",
        "于是笨笨迅速键入“home”……",
        "只见一阵烟雾过後，笨笨的身影已经不见了。",
});
...
string give_gift()
{
        ...
        if (sizeof(players) >= 5)
        {
               ...
               tell_object(ob,HIW"一阵轰隆隆的雷声响过，一道闪电从天而降，不偏不倚\n"
                		"的砸到你头上，你登时就晕了过去……\n\n" NOR);
                tell_object(ob,"不过，好在你感觉自己的内力更加精湛了!\n");
                ob->unconcious();
