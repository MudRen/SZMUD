...
int do_shoot(string arg)
{
        ...
        if (env->query("pigging") || (env->query("short") == RED"武庙"NOR) || env->query("sleep_room") || env->query("no_fight") || env->query("canScheme"))
        ...
        if( !undefinedp(default_dirs[dir]) )
		  ...
		  if (obj->query("pigging") || (obj->query("short") == RED"武庙"NOR) || obj->query("sleep_room") || obj->query("no_fight") || obj->query("canScheme"))
