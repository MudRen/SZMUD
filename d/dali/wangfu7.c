...
void create()
{
	set("short", "承光壁");
	set("long", @LONG
这是一道石壁，上面刻有九龙戏珠图，九龙张牙舞爪，神态
各不相同。东边尊玉佛，高一点五米，由一整块白玉雕刻而成。
又有一只玉碗，直径一点五米，由一整块黑玉雕刻而成。外面雕
有海龙及海兽。
LONG
	);
	set("cost", 1);
