...
void create()
{
	set("short", "迷宫树林");
	set("long", @LONG
这是迷宫中的一个路口，但见四下黑森森的都是树木，脚下小
路东盘西曲，密林中难辨方向，举步踏到的尽是矮树杂草，荆棘钩
刺到小腿，划得你鲜血淋淋。一个小木桩上钉了五个木牌，分别指
向五条小路，并标明“金，木，水，火，土”。北边树木稀少些，
看来可以是走出去(out)的方向。
LONG );
	set("exits", ([
		"金" : __FILE__,
