...
void create()
{
	set_name("冰雕儿", ({ "emei dizi", "dizi", "bwxy" }));
//	set("long", "一位十来岁的少年女尼，长得清秀绝俗，表情冷峻，令人丝毫不敢有亵渎之意。\n");
	set("long", "她长得清秀绝俗，表情冷峻，令人丝毫不敢有亵渎之意。\n");
	...
	set("chat_chance", 6);
        set("chat_msg", ({
	             "冰雕儿道: 想吃椰子吗？请小僮帮你打开吧。\n",
                     "冰雕儿道: 想吃椰子吗？你找个石块试着砸一砸它吧。\n",
                     "冰雕儿道: 其实有水喝就行了，椰子的用处大着呢。嘻嘻。\n",
                     "冰雕儿道: 听说有位医生最爱吃椰子，你若是给他椰子，他可以帮你疗伤。\n",
	}) );
...
{	
	...
	{	
		...
		command("say 这位" + RANK_D->query_respect(me) + "若有兴致来峨眉山一游，我们欢迎之至。\n"+
	     "你有什麽问题问我就好啦。"+HBRED+HIW"(ask bwxy about 峨眉) (help emei)"NOR);
