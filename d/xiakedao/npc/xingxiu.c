...
void create()
{
        set_name("剑无痕", ({ "xingxiu dizi", "dizi", "jwh"}));
        set("long", 
	...
	set("inquiry", ([
        ...
        set("chat_chance", 2);
        set("chat_msg", ({
"剑无痕敲着铜钹，高声唱道，“星～宿～老～仙，威～震～寰～宇”。\n",
"剑无痕敲着铜钹，高声唱道，“星～宿～老～仙，德～配～天～地”。\n",
"剑无痕敲着铜钹，高声唱道，“星～宿～老～仙，古～今～无～比”。\n",
        }) );
...
{	if (me->query_temp(this_object()->query("id")) == 0 )
	{	
		...
		command("say " + RANK_D->query_respect(me) + 
			"星宿老仙武功天下第一，只要你马屁功高，\n"+
			"就能出人投地。你有什麽问题问我就好啦。\n"+
			HBRED+HIW"(ask jwh about 星宿)"NOR + " 或 "+HBRED+HIW"(help xingxiu)"NOR +"。");
