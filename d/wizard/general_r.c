...
LONG
        ...
        set("exits", ([ 
             ...
             "east" : "/d/wizard/lnerekaifa",
             "north" : "/d/wizard/slowroom",
             "west" : "/d/wizard/lneremenpai",
        ...
        set("cost", 0);
        setup();
        call_other("/clone/board/devide_b", "???");
        call_other("/clone/board/new_pro", "???");
}
