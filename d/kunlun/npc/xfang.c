...
void create()
{
	...
	set("shen_type", -1);
        ...
        set("attitude","frindly");
          set_skill("force", 75 + random(10));
          set_skill("strike", 60 + random(20));
           set_skill("taxue-wuhen", 70 + random(20));
        set_skill("kunlun-zhang", 55 + random(30));
       set_skill("dodge", 70 + random(20));
         set_skill("parry", 90);
         set_skill("xuantian-wuji", 80 + random(10));
