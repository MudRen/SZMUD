...
{
      int lvl, player, opp, diff, expdif;
          string strMsg;
      ...
      if( (int)me->query("neili") < 200 )
          ...
          expdif = me->query("combat_exp") + random(100000) - target->query("combat_exp") + random(100000);

          if( expdif < random(100) )
          {
                  diff = 0;
          }
          ...
          if(diff < 1)
          {
                  ...
                  message_vision(strMsg, me, target);
          ...
          else if(diff < 50)
          {
                  ...
                  strMsg = HIR + "$n使出本门轻功并解正面迎敌将$N使出十成功力瞬间消为六成。\n"+NOR;
                  message_vision(strMsg, me, target);
          ...
          else if(diff < 100)
          {
                  ...
                  strMsg = HIR + "$n摆出招架的姿势看准了$N的攻击目标，$n使用全力招架了几下发现自己像稻草一样的飞了出去。\n"+NOR;
                  message_vision(strMsg, me, target);
          ...
          else
          {
                  ...
                  strMsg = HIR + "$n看着$N出的招数完全无法预测目标，$n被$N就以" + HIC + "上" + HIW + "，" + HIR + "中" + HIW + "，" + HIG + "下" + HIW + "，闪电般的攻击丝毫没有反击能力。\n"+NOR;
                  message_vision(strMsg, me, target);
