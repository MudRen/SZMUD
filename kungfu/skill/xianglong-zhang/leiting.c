...
int perform(object me, object target)
{
	...
	if( me->query_skill("force") < 134 )
		return notify_fail("你的混天气功火候未到，无法施展雷霆降龙！\n");

	if( me->query_skill("strike") < 134 )
	...
	lvl = ( me->query_skill("strike") - 135 ) / 20;
	skill = me->query_skill("force");
	amount = skill/2;

	me->add_temp("apply/attack", (amount*3/2)* (lvl+20) / 20);
	me->add_temp("apply/strike", (amount/2)* (lvl+20) / 20);
