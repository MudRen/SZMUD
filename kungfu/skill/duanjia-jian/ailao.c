...
----------------------------------------------------------------------
修改功能：perform ailao，增加jifa dodge和jifa parry各10%。
                  条件：同原有功能。
                  限制：使用过后busy 3-4 tick。
***********************************************************************
snowyu 注:
pfm ailao 如果在combo 瞬间提高apply parry 和dodge 是不会起到什么效果的
瞬间combo 在于attack damage speed 既然ailao 已经固定与这样的模式
我将lnere 所注加入 dodge parry 改为 damage 和attack  来提高攻击力
这样几乎和剑掌五连环是一样的物理攻击
dodge 和parry 加与不加没有太大的区别
***********************************************************************
