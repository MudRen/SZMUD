...
void init()
{
        set("inquiry/name","贫道便是清虚，不知这位" + RANK_D->query_respect(this_player()) +"有何见教？");
        set("inquiry/武当","贫道便是武当派弟子，不知这位" + RANK_D->query_respect(this_player()) +"有何见教？");
        set("inquiry/武当派","贫道便是武当派弟子，不知这位" + RANK_D->query_respect(this_player()) +"有何见教？");
        set("inquiry/清虚道长","贫道便是武当派弟子，不知这位" + RANK_D->query_respect(this_player()) +"有何见教？");
        set("inquiry/清虚","贫道便是武当派弟子，不知这位" + RANK_D->query_respect(this_player()) +"有何见教？");
}
