...
string read_file( string file ,int lines ,int line)
{
  object user = this_object();
...
{
  log_file("/static/EDIT_LOG", sprintf("%s %s(%s) tried to edit %s.\n", ctime(time()), this_player()->query("id"), wizhood(this_player()), file));
}*/
