...
mapping curing_msg(object me, object target)
{
	...
	return ([
		...
		"start_healother_other":MAG+ me->name()+ "坐下运起紫霞功，连连拍按"+target->name()+"各处命门大穴，徐徐地将真气输入"+target->name()+"体内....\n",
		"start_healother_self" :(["me" : MAG+"你坐下运起紫霞功，连连拍按"+target->name()+"各处命门大穴，\n徐徐地将真气输入"+xb+"的体内，为"+xb+"运功疗伤。\n",
					"target" : MAG+ me->name()+ "坐下运起紫霞功，连连拍按你的各处命门大穴，\n徐徐地将真气输入你的体内，为你运功疗伤。\n",])
	]);
}
