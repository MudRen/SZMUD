...
case "星宿派":
    ...
    break;
     ...
     target->move(yangpath[random(sizeof(yangpath))]);
      msg="听说"+yangguo[random(sizeof(yangguo))]+"派了密探到了"+yangwhere[random(sizeof(yangwhere))]+"你去把他干了!\n";
...
string ask_finish()
{
    object me=this_player();
     ...
     if(!me->query("yang/finish") || me->query("fam/family_name") != "古墓派")
        return "你完成了什么？\n";
    ...
    me->apply_condition("yang_finish",10+random(10));
    return "做的很好，下去休息吧。\n";
}
...
string ask_abandon()
{
    ...
    if(!me->query("yang/job"))
        return "你又没工作，放弃什么？\n";
    me->delete("yang/job");
    me->apply_condition("yang_job",30+random(10));
