...
{      
    ...
    {
                  tell_object(me,CYN"管事向你吼道：磨蹭什么？还不快去！\n"NOR);
                    tell_object(me,CYN"管事向你吼道：要是完成了,就告诉我一声!\n"NOR);
                return 1;
    } 
    else 
...
{      
    ...
    me->delete_temp("obj");
        ...
        me->add("potential",20+random(10));
        if(me->query("potential")>me->query("max_potential"))
        me->set("potential",me->query("max_potential"));


    if(me->query_skill("qinqi_shuhua",1)<30)
          me->improve_skill("qinqi-shuhua",50);
