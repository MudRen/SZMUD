// 苏梦馨(Athena) 闲着没事，找到了这只鹦鹉，这个小家伙很有意思哦！ 
// NPC：/u/athena/npc/parrot.c 
...
void create()
{
        ...
        set("inquiry", ([
                "name": (: ask_name :),
               "athena": "你想知道吗？可我不想告诉你！",
                "here": "你个大白痴，我又不是人，怎么会知道？！",
                "爱": "爱一个人需要理由吗？不需要吗？需要吗？不需要吗？需要吗？不需要吗？......",
                "暗号" : "这都不知道？去看《富贵兵团》！",
                "妖": "所以说做妖就象做人一样,要有仁慈的心,有了仁慈的心,就不再是妖,是人妖。",
               "大哥" : "你化这个妆就说自己是大哥喽？给点儿专业精神好不好！那些毛通通都开叉了,头上象戴了两块年糕,出来混饭得花本钱嘛！",
                "帐户" : "先对上暗号再告你密码！",
                "你好": "这个家伙没事就长篇大论婆婆妈妈叽叽歪歪,就象有一只苍蝇,嗡.对不起,不是一只,是一堆苍蝇围着你,嗡嗡飞到你耳朵里。",
                "财神" : (: ask_caishen :),
    ...
    if (this_player()->query_temp("parrot")) {
      if (!follow_ob) {
        ...
        this_player()->delete_temp("parrot");
                ...
                return "什么密码？Athena的登录密码吗？我试了" + chinese_number(password_try) + "次了，还没试出来....";
        }
}
