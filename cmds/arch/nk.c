...

{
	...
	shout( HIG"【比武精灵】比武正式开始，由" + name1 + "对" + name2 + "！\n"NOR);

	write( HIG"【比武精灵】比武正式开始，由" + name1 + "对" + name2 + "！\n"NOR);
...

{
...

	{
		...
		shout(HIG"【比武精灵】" +obj->query("name") + "落荒而逃了！\n"NOR);

		write(HIG"【比武精灵】" +obj->query("name") + "落荒而逃了！\n"NOR);
...

	{
		...
		shout( HIG"【比武精灵】" +dest->query("name") + "落荒而逃了！\n"NOR);

		write( HIG"【比武精灵】" +dest->query("name") + "落荒而逃了！\n"NOR);
...

	{
		...
		shout( HIG"【比武精灵】"+ obj->query("name") +"中途放弃比武！\n"NOR);

		write( HIG"【比武精灵】"+ obj->query("name") +"中途放弃比武！\n"NOR);
...

	{
		...
		shout( HIG"【比武精灵】"+ dest->query("name") +"中途放弃比武！\n");

		write( HIG"【比武精灵】"+ dest->query("name") +"中途放弃比武！\n");
...

	{
		...
		if  (dest->query("qi")*2 > dest->query("max_qi")) {
			...
			shout( HIG"【比武精灵】" + obj->query("name") 

				+ "与" + dest->query("name") + "比武不分胜负！\n"NOR);

			write( HIG"【比武精灵】" + obj->query("name") 
...

	{
		...
		shout( HIG"【比武精灵】" + dest->query("name") 

			+ "比武战胜" + obj->query("name") + "！\n"NOR);

		write( HIG"【比武精灵】" + dest->query("name") 
